...
export const FALLBACK_STOCK_RATES: Record<string, StockQuoteItem> = {
  SSI: {
    ...
    low30w: 17350,
    low52w: 17350,
    diffFromLow5wPct: 10.2,
    diffFromLow10wPct: 21.9,
    diffFromLow20wPct: 21.9,
    diffFromLow30wPct: 21.9,
    diffFromLow52wPct: 21.9,
  ...
  FPT: {
    ...
    low30w: 61500,
    low52w: 61500,
    diffFromLow5wPct: 9.3,
    diffFromLow10wPct: 20.8,
    diffFromLow20wPct: 20.8,
    diffFromLow30wPct: 20.8,
    diffFromLow52wPct: 20.8,
    valuationStatus: 'Tăng trưởng bền vững',
  },
  TCB: {
    symbol: 'TCB',
    name: 'Techcombank',
    ...
    low30w: 27770,
    low52w: 27770,
    diffFromLow5wPct: 6.7,
    diffFromLow10wPct: 17.4,
    diffFromLow20wPct: 17.4,
    diffFromLow30wPct: 17.6,
    diffFromLow52wPct: 17.6,
    valuationStatus: 'Tích lũy an toàn',
  },
  MBB: {
    symbol: 'MBB',
    ...
    low30w: 17780,
    low52w: 17780,
    diffFromLow5wPct: 4.8,
    diffFromLow10wPct: 15.6,
    diffFromLow20wPct: 15.6,
    diffFromLow30wPct: 15.6,
    diffFromLow52wPct: 15.6,
    valuationStatus: 'Vùng gom định giá thấp',
  },
  VCB: {
    symbol: 'VCB',
    name: 'Vietcombank',
